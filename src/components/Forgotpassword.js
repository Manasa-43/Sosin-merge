...
export default function Forgotpassword() {
  return (
    <ul className="d-flex list-unstyled">
       ...
       <li className="px-2">
       <FontAwesomeIcon icon={faYoutube} className=" icon-bg fa-x  "/>
       </li>
       <li className="px-2">
       <FontAwesomeIcon icon={faFacebook} className="icon-bg fa-x"/>
       </li>
       <li className="px-2">
       <FontAwesomeIcon icon={faInstagram} className="icon-bg fa-x "/>
       </li>
       <li className="px-2">
       <FontAwesomeIcon icon={faTwitter} className="icon-bg fa-x "/>
       </li>
